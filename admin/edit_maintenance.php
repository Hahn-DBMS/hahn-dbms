...
$Task_err = $Date_completed_err = $Section_id_err =  $Section_id_err = "";
...
$query = "SELECT * FROM MAINTENANCE WHERE Task_id = $id";
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty(trim($_POST["Task"]))) {
        $Task_err = $Task = "Please enter a task.";
    } else {
    ...
    if(empty(trim($_POST["Date_completed"]))) {
        $Date_completed_err = "Please enter a date.";
    } else {
    ...
    if(empty(trim($_POST["Section_id"]))) {
        $Section_id_err = $Section_id = "Please enter a section.";
    } else {
    ...
    if(empty($Task_err) && empty($Date_completed_err) && empty($Staff_id_err) && empty($Section_id_err)){
        ...
        $sql = "UPDATE MAINTENANCE SET Task = ?, Date_completed = ?, Staff_id = ?, Section_id = ? WHERE Task_id = ?";

             
        if($stmt = mysqli_prepare($link, $sql)){
            // Bind variables to the prepared statement as parameters
            mysqli_stmt_bind_param($stmt, "ssssi", $param_Task, $param_Date_completed, $param_staff_id, $param_section_id, $id);
    ...
    <div class="wrapper">
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" name="Date_completed" class="form-control <?php echo (!empty($Date_completed_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $Date_completed; ?>">
