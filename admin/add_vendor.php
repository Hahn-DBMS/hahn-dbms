...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty(trim($_POST["Vendor_name"]))) {
        $Vendor_name_err = "Please enter a valid name.";
    } else {
    ...
    if(empty(trim($_POST["Contact_info"]))) {
        $Contact_info_err = "Please enter a means of contact.";
    } else {
    ...
    if(empty($Vendor_name_err) && empty($Point_of_contact_err) && empty($Contact_info_err) && empty($Vendor_type_err)){
        ...
        $sql = "INSERT INTO VENDOR (Vendor_name , Point_of_contact , Contact_info , Vendor_type ) VALUES (?, ?, ?, ?)";

             
        if($stmt = mysqli_prepare($link, $sql)){
            // Bind variables to the prepared statement as parameters
            mysqli_stmt_bind_param($stmt, "ssss", $param_Vendor_name, $param_Point_of_contact, $param_Contact_info, $param_Vendor_type);
    ...
    <div class="wrapper">
        ...
        <div class="form-group">
            ...
            <div class="form-group">
                ...
                <span class="invalid-feedback"><?php echo $Vendor_info_err; ?></span>
            </div>
