...
$dataPoints = array();
$query = 'SELECT (DATE_FORMAT(S.Order_date,"%M")) AS "Month", COUNT(*) AS Orders, (DATE_FORMAT(S.Order_date,"%Y")) AS "Year" FROM SUPPLIES_ORDER S GROUP BY (DATE_FORMAT(S.Order_date,"%M")) ORDER BY max(MONTH(S.Order_date)) ASC;';
  ...
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Orders All Time | <?php echo $total?> Orders</h1>
