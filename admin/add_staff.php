...
$fname = $lname = $username = $password = $confirm_password = $admin = "";
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($username_err) && empty($password_err) && empty($confirm_password_err)){
        ...
        $sql = "INSERT INTO STAFF (First_name, Last_name, username, password, admin_bool) VALUES (?, ?, ?, ?, ?)";
         
        if($stmt = mysqli_prepare($link, $sql)){
            // Bind variables to the prepared statement as parameters
            mysqli_stmt_bind_param($stmt, "ssssi", $param_fname, $param_lname, $param_username, $param_password, $admin);
    ...
    <div class="wrapper">
        ...
        <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="checkbox" name="admin" id="admin" value=<?php echo $admin; ?> <?php echo ($admin == 1 ? 'checked': '')?>>
                <label for="admin"> Admin</label><br>
                <span class="invalid-feedback"><?php echo $confirm_password_err; ?></span>
            </div>
            <div class="form-group">
                <input type="submit" class="btn btn-primary" value="Submit">
                <a href="staff.php" class="btn btn-secondary ml-2">Cancel</a>
            </div>
        </form>
    </div>    
